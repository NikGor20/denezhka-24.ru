<html lang="ru"><head>
    ...
    <body>
        ...
        <div data-v-62e73374="" class="safepay">
            <div data-v-615831e0="" data-v-62e73374="" class="secondmenu">
                <div data-v-615831e0="" class="container">
                    <div data-v-615831e0="" class="row justify-content-center">
                        ...
                        <div data-v-615831e0="" class="secondmenulinkrow">
                            <a data-v-615831e0="" href="./safepay.php" aria-current="page" class="secondmenulink nuxt-link-exact-active nuxt-link-active">Оплата и безопасность</a>
                        </div>
                        <div data-v-615831e0="" class="secondmenulinkrow">
            ...
            <h2 data-v-62e73374="">Оплата и безопасность</h2> 
            <div data-v-62e73374="" class="safeblock1">
                <div data-v-62e73374="" class="safetext">
                    <h3 data-v-62e73374="">Уважаемый клиент!</h3>
                    <p data-v-62e73374="" class="safepayp">
                        Вы можете оплатить свою услугу онлайн с помощью банковской карты через
                        платежный сервис. После подтверждения услуги Вы будете перенаправлены
                        на защищенную платежную страницу, где необходимо будет ввести данные
                        для оплаты услуги. После успешной оплаты на указанную в форме оплаты
                        электронную почту будет направлен электронный чек с информацией об
                        услуге и данными по произведенной оплате.
                    </p>
                </div> 
                <div data-v-62e73374="" class="safetext1">
                    <h3 data-v-62e73374="">Гарантии безопасности</h3>
                    <p data-v-62e73374="" class="safepayp">
                        Безопасность процессинга подтверждена сертификатом стандарта
                        безопасности данных индустрии платежных карт PCI DSS. Надежность
                        сервиса обеспечивается интеллектуальной системой мониторинга
                        мошеннических операций, а также применением 3D Secure - современной
                        технологией безопасности интернет-платежей. Данные Вашей карты
                        вводятся на специальной защищенной платежной странице. Передача
                        информации в процессинговую компанию происходит с применением
                        технологии шифрования TLS. Дальнейшая передача информации
                        осуществляется по закрытым банковским каналам, имеющим наивысший
                        уровень надежности.
                    </p>
                </div>
            </div>
