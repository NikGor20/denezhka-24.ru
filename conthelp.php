            ...
            <div data-v-615831e0="" class="secondmenu">
                <div data-v-615831e0="" class="container">
                    <div data-v-615831e0="" class="row justify-content-center">
                        ...
                        <div data-v-615831e0="" class="secondmenulinkrow">
                            <a data-v-615831e0="" href="./conthelp.php" aria-current="page" class="secondmenulink nuxt-link-exact-active nuxt-link-active">Контакты и помощь</a>
                        </div>
                    </div>
                </div>
            </div>
            <h2>Контакты и помощь</h2>
            <div class="conthelpblock">
                <div class="conthelpform">
                    <h4>Обратная связь</h4>
                    <p>
                        Если у вас процессе пользования нашим сервисом возникли вопросы, наши
                        специалисты готовы вам помочь
                    </p>
                    <form class="">
                        <div>
                            <input id="input-2" type="text" placeholder="Ваше имя*" required="required" aria-required="true" class="form-control">
                            <pre class="mt-3 mb-0"></pre>
                        </div>
                        <div>
                            <input id="input-1" type="email" placeholder="Ваш E-mail*" required="required" aria-required="true" class="form-control"> 
                            <pre class="mt-3 mb-0"></pre>
                        </div>
                        <div>
                            <textarea id="textarea" placeholder="Ваше сообщение" wrap="soft" class="form-control" type="message" style="resize: none; overflow-y: scroll; height: 125px;">                             
                            </textarea>
                            <pre class="mt-3 mb-0"></pre>
                        </div> 
                        <div class="conthelpbtn">
                            <button type="submit" class="btn submitbtn btn btn-secondary">ОТПРАВИТЬ</button>
                            <button type="button" class="btn telegrambtn btn btn-secondary">
                                <a href="https://tlgg.ru/@ivanmfo" class="TelegBtn1" style="color: white;">
                                    <img src="images/telega.svg" alt="" class="img-fluid">
                                    Написать в Telegram </a>
                            </button>
                        </div>
                    </form>
                </div> 
                <div class="conthelpblock2">
                    <img src="images/img/cont_astronavt.png" alt="" class="img-fluid"> 
                    <div class="conthelpphone">
                        <p class="phonetext">
                            <img src="images/img/cmap_smartphone.svg" alt="" class="img-fluid">Телефон горячей линии
                        </p>
                        <a href="tel:8499342500">
                            <p class="phonenumber">+7 (499) 342 95-00</p>
                        </a>
                    </div> 
                    <div class="conthelpemail">
                        <p class="emailtext">
                            <img src="images/img/cmap_email.svg" alt="" class="img-fluid">E-mail
                        </p>
                        <a href="mailto:support@microzaym.site">
                            <p class="emaillink">support@microzaym.site</p>
                        </a>
                    </div>
                </div>
            </div>
